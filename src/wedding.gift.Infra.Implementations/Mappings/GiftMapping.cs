...
public sealed class GiftMapping : IEntityTypeConfiguration<Gift>
{
    ...
    private static IEnumerable<Gift> GetSeedGifts()
    {
        ...
        [
            ...
            Gift.Seed(Guid.Parse("b8db2a9c-ee89-41f7-b50a-6d9fa59e34fc"), "Liquidificador 1200W", "Liquidificador potente com copo de vidro.", 459.90m, 459.90m, "https://images.example.com/liquidificador.jpg", "Eletrodomésticos", true, createdAt),
            ...
            Gift.Seed(Guid.Parse("df173a4e-d8f8-472f-ae72-7b64e3e8f076"), "Aparelho de Jantar 20 Peças", "Conjunto de jantar em porcelana branca.", 519.00m, 519.00m, "https://images.example.com/aparelho-jantar.jpg", "Mesa", true, createdAt),
            Gift.Seed(Guid.Parse("42fdcc72-664b-4d65-95e2-e8f4f906f28b"), "Aspirador Robô", "Aspirador inteligente com base carregadora.", 1299.00m, 1299.00m, "https://images.example.com/aspirador-robo.jpg", "Casa", true, createdAt),
            Gift.Seed(Guid.Parse("0ac3abdd-0c2d-4234-b72b-b327d8563af7"), "Cafeteira Expresso", "Cafeteira automática para cápsulas e pó.", 699.90m, 699.90m, "https://images.example.com/cafeteira.jpg", "Cozinha", true, createdAt)
        ];
    }
}
