...
namespace wedding.gift.Infra.Implementations.Migrations
{
    ...
    [Migration("20260804231336_UpdateSeedGiftCoupleId")]
    partial class UpdateSeedGiftCoupleId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wedding.gift.Domain.Model.Entities.ConfirmedGuest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("GuestConfirmationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("wedding.gift.Domain.Model.Entities.Gift", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Category = "Cozinha",
                            CoupleId = new Guid("1107b70c-c715-4672-9d51-73db9ed8d4fb"),
            ...
            modelBuilder.Entity("wedding.gift.Domain.Model.Entities.GuestConfirmation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CoupleId", "ConfirmedAtUtc");

                    b.ToTable("GuestConfirmations");
                });

            modelBuilder.Entity("wedding.gift.Domain.Model.Entities.GuestInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CoupleId", "NormalizedName")
                        .IsUnique();
            ...
            modelBuilder.Entity("wedding.gift.Domain.Model.Entities.WebhookInboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WebhookInboxMessages");
                });

            modelBuilder.Entity("wedding.gift.Domain.Model.Entities.ConfirmedGuest", b =>
                {
                    b.HasOne("wedding.gift.Domain.Model.Entities.GuestConfirmation", "GuestConfirmation")
                        .WithMany("Guests")
                        .HasForeignKey("GuestConfirmationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("wedding.gift.Domain.Model.Entities.GuestInvitation", "GuestInvitation")
                        .WithMany()
                        .HasForeignKey("GuestInvitationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("GuestConfirmation");
