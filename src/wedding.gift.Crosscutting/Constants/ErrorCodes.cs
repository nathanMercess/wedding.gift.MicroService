...
public static class ErrorCodes
{
    ...
    public const string GUEST_INVITATION_NOT_FOUND = "GUEST_INVITATION_NOT_FOUND";
    public const string GUEST_CONFIRMATION_NOT_FOUND = "GUEST_CONFIRMATION_NOT_FOUND";
    public const string GUEST_INVITATION_ALREADY_EXISTS = "GUEST_INVITATION_ALREADY_EXISTS";
    public const string GUEST_INVITATION_ALREADY_CONFIRMED = "GUEST_INVITATION_ALREADY_CONFIRMED";
    public const string INVALID_GUEST_CONFIRMATION = "INVALID_GUEST_CONFIRMATION";
    public const string GUEST_INVITATION_INACTIVE = "GUEST_INVITATION_INACTIVE";
    public const string DUPLICATE_GUEST_NAME = "DUPLICATE_GUEST_NAME";
    public const string INVALID_GUEST_IMPORT = "INVALID_GUEST_IMPORT";
